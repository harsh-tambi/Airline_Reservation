...
-- Creating all the tables to set up the database for Part 3
-- After tables are added and linked in the database, it would be then connected to the Django Framework
