...
def customernewsletter(request):
...
def purchaseticket(request):
    if request.method == 'POST':
        ...
        if previous_purchased:
            message = 'Customer is only allowed to buy one ticket! You have already purchased one ticket.'
        ...
        print (msg)
        # email_sender = 'harshtambi1503@gmail.com'
        # email_password = 'yphfdiopcghvalay'
        ...
        res = send_mail(subject, msg, settings.EMAIL_HOST_USER, [customer_email, 'harshtambi1503@gmail.com', 'ht2293@nyu.edu'], fail_silently=True)
